...
We can see the model is very bad at predicting hate speech, with 0 beeing hate speech and 1 beeing offensive language. 
...
We run the recipies on the trainging and test data. 
```{r}
